...
public class NetworkAnnotationProcessor extends AbstractProcessor {
    ...
    private void implementCustomPacketPayload(Set<? extends Element> sources) {
        sources.forEach(element -> {
            try {
                ...
                JavaFileObject proxyClass = processingEnv.getFiler().createSourceFile("t88.packets." + originalClassName, originalClass);
    ...
    private void generateRegistry(Set<? extends Element> sources) {
        try {
            ...
            String packageName = anySourceClassName.substring(0, anySourceClassName.lastIndexOf(".")) + GENERATED_PACKAGE_SUFFIX;
